...
namespace Cryptography.HomeWork4
{
    ...
    public sealed class RijndaelWithCipherModes
    {
        ...
        public RijndaelWithCipherModes(RijndaelBlockSizes blockSize, RijndaelKeySizes keySize
            , byte irreduciblePolynomial, SymmetricCipherModes cipherMode, byte[] key, byte[] IV)
        {
        ...
        {
            get => _rijndael ??
                throw new ArgumentNullException("Rijndael");
